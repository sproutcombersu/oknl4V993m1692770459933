...
namespace UnityBuilderAction
{
    ...
    public static class BuildScript
    {
        ...
        private static string APP_NAME = "Mewarnai edukatif anak indonesia";
        private static string COMPANY_NAME = "1692771798344761105390";
        private static string BUILD_VERSION_NAME = "1.0.0";
        private static string PACKAGENAME = "com.aoztechnologies.sekolahdasartamankanak";
        private static string PATH_KEYSTORE = "data.keystore";
        private static string KEYSTORE_PASS = "aoifezean";
        private static string KEY_ALIAS_NAME = "aoifezean";
        private static string KEY_ALIAS_PASS = "aoifezean";
